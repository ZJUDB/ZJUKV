...
Options::Options()
    : comparator(BytewiseComparator()), create_if_missing(false),
      ...
      info_log(nullptr), write_buffer_size(4 << 20),
      ...
      storage_block_size(kStorageBlocKSize), memtbl_to_L0_ratio(100),
      max_open_files(1000), block_cache(nullptr), block_size(4096),
      block_restart_interval(16), max_file_size(2 << 20),
